...
class com.f1sr.aswing.plaf.winxp.WinXPLAF extends BasicLookAndFeel
{
	public function WinXPLAF(){
		super();
	}
	...
	private function initClassDefaults(table:UIDefaults):Void{
		...
		var uiDefaults:Array = [
		   "ButtonUI", com.f1sr.aswing.plaf.winxp.ButtonUI,
			"ToggleButtonUI", com.f1sr.aswing.plaf.winxp.ToggleButtonUI,
			"ComboBoxUI",com.f1sr.aswing.plaf.winxp.ComboBoxUI,
			
			"TextFieldUI",com.f1sr.aswing.plaf.winxp.TextFieldUI,
        	"TextAreaUI",com.f1sr.aswing.plaf.winxp.TextAreaUI,
        	"ScrollBarUI",com.f1sr.aswing.plaf.winxp.ScrollBarUI,
        	"TabbedPaneUI", com.f1sr.aswing.plaf.winxp.TabbedPaneUI,
        	"WindowUI",com.f1sr.aswing.plaf.winxp.WindowUI,	
			//"PanelUI",com.f1sr.aswing.plaf.winxp.PanelUI,
			"FrameUI",com.f1sr.aswing.plaf.winxp.FrameUI,
			"ScrollBarButtonUI",com.f1sr.aswing.plaf.winxp.button.ScrollBarButtonUI
	...
	private function initSystemColorDefaults(table:UIDefaults):Void{
			var defaultSystemColors:Array = [
			  ...
			  "inactiveCaptionBorder", 0x7999DE, /* Border color for inactive caption (title bar) window borders. */
				         ...
				         "window", 0xEFECDE,//XP = 0xF1F1EB, /* Default color for the interior of windows */
				   "windowBorder", 0x002D86, /* ??? */
			         ...
			         "modalColor", 0xFFFFFF,
					   ...
					   "text", 0xFFFFFF, /* Text background color */
				       "textText", 0x000000, /* Text foreground color */
				  "textHighlight", 0x316AC5, /* Text background color when selected */
			      "textHighlightText", 0xFFFFFF, /* Text color when selected */
			       "textInactiveText", 0xACA899, /* Text color when disabled */
				        
				        "control", 0xEFECDE,//0x9EBEF5,//0xBCD3F2,//0x84ACDF,//XP = 0xF1F1EB  /* Default color for controls (buttons, sliders, etc) */
				  "controlBorder", 0x003C74,//for XP = 0x003C74,//0xEFEFEF, /* Default color for controls (buttons, sliders, etc) */
				  "controlTextFieldBorder",0x7F9DB9, // Border for input text fields combos' text area etc
			       ...
			       "controlHighlight", 0xACA899, /* Specular highlight (opposite of the shadow) */
			     "controlLtHighlight", 0xFFFFFF,// for XP = 0xFFFFFF, /* Highlight color for controls */
				  "controlShadow", 0xAEB2B6,//0xAEB2B6, /* Shadow color for controls */
			        "controlDkShadow", 0x757575, /* Dark shadow color for controls */
	...
	private function initComponentDefaults(table:UIDefaults):Void{
	   ...
	   comDefaults = [
		    ...
		    "Button.border", com.f1sr.aswing.plaf.winxp.border.ButtonBorder
		    ];
	    table.putDefaults(comDefaults);
	    
	    // *** ToggleButton
	    comDefaults = [
	   		"ToggleButton.borderColor", table.get("controlBorder"),
	    	"ToggleButton.background", table.get("control"),	    
		    "ToggleButton.border", com.f1sr.aswing.plaf.winxp.border.ButtonBorder
	    ...
	    // *** RadioButton
	    comDefaults = [
		    "RadioButton.icon", com.f1sr.aswing.plaf.winxp.icon.RadioButtonIcon];
	    table.putDefaults(comDefaults);	    
	    	    
	    // *** CheckBox
	    comDefaults = [
		    "CheckBox.icon", com.f1sr.aswing.plaf.winxp.icon.CheckBoxIcon];
	    table.putDefaults(comDefaults);
	    ...
	    comDefaults = [
	    	...
	    	"ComboBox.border", com.f1sr.aswing.plaf.winxp.border.ComboBoxBorder
	    ...
	    comDefaults = [
        	...
        	"TextField.border",com.f1sr.aswing.plaf.winxp.border.TextFieldBorder
	    ...
	    comDefaults = [
        	...
        	"TextArea.border",com.f1sr.aswing.plaf.winxp.border.TextFieldBorder
	   ...
	   // *** JTabbedPane
	    ...
	    // *** Frame
	    comDefaults = [	   
	    	"Frame.backround", table.get("modalColor"),
	    	"Frame.foreground", table.get("windowText"),
	    	"Frame.titleBarUI", com.f1sr.aswing.plaf.winxp.frame.WinXPTitleBarUI,
	    	"Frame.border", com.f1sr.aswing.plaf.winxp.border.FrameBorder
	...
	private function initSystemFontDefaults(table:UIDefaults):Void{
		var defaultSystemFonts:Array = [
				"systemFont", new ASFontUIResource("Arial", 10), 
				"menuFont", new ASFontUIResource("Arial", 10), 
