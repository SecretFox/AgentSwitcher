...
import GUI.fox.aswing.plaf.InsetsUIResource;
 ...
 * @author iiley
 */
class GUI.fox.aswing.plaf.basic.BasicLookAndFeel extends LookAndFeel{
	...
	private function initClassDefaults(table:UIDefaults):Void{
		var uiDefaults:Array = [
			   //"ButtonUI", GUI.fox.aswing.plaf.basic.BasicButtonUI,
			   //"PanelUI", GUI.fox.aswing.plaf.basic.BasicPanelUI,
			   //"ToggleButtonUI", GUI.fox.aswing.plaf.basic.BasicToggleButtonUI,
			   //"RadioButtonUI", GUI.fox.aswing.plaf.basic.BasicRadioButtonUI,
			   //"CheckBoxUI", GUI.fox.aswing.plaf.basic.BasicCheckBoxUI,
			   //"ScrollBarUI", GUI.fox.aswing.plaf.basic.BasicScrollBarUI,
			   //"ScrollPaneUI", GUI.fox.aswing.plaf.basic.BasicScrollPaneUI,
			   //"ViewportUI", GUI.fox.aswing.plaf.basic.BasicViewportUI,
			   //"WindowUI", GUI.fox.aswing.plaf.basic.BasicWindowUI,
			   //"FrameUI", GUI.fox.aswing.plaf.basic.BasicFrameUI,
			   //"ListUI",GUI.fox.aswing.plaf.basic.BasicListUI,
			   //"LabelUI",GUI.fox.aswing.plaf.basic.BasicLabelUI,
			   //"ToolTipUI",GUI.fox.aswing.plaf.basic.BasicToolTipUI,
			   //"TextFieldUI", GUI.fox.aswing.plaf.basic.BasicTextFieldUI,
			   //"TextAreaUI", GUI.fox.aswing.plaf.basic.BasicTextAreaUI,
			   //"ToolBarUI", GUI.fox.aswing.plaf.basic.BasicToolBarUI,
			   //"AccordionUI", GUI.fox.aswing.plaf.basic.BasicAccordionUI,
			   //"TabbedPaneUI", GUI.fox.aswing.plaf.basic.BasicTabbedPaneUI,
			   //"ComboBoxUI", GUI.fox.aswing.plaf.basic.BasicComboBoxUI,
			   //"SeparatorUI", GUI.fox.aswing.plaf.basic.BasicSeparatorUI,
			   //"ProgressBarUI", GUI.fox.aswing.plaf.basic.BasicProgressBarUI,
			   //"TableUI", GUI.fox.aswing.plaf.basic.BasicTableUI,
			   //"TableHeaderUI", GUI.fox.aswing.plaf.basic.BasicTableHeaderUI,
			   //"SliderUI", GUI.fox.aswing.plaf.basic.BasicSliderUI,
			   //"AdjusterUI", GUI.fox.aswing.plaf.basic.BasicAdjusterUI,
			   //"ColorSwatchesUI", GUI.fox.aswing.plaf.basic.BasicColorSwatchesUI,
			   //"ColorMixerUI", GUI.fox.aswing.plaf.basic.BasicColorMixerUI,
			   //"ColorChooserUI", GUI.fox.aswing.plaf.basic.BasicColorChooserUI,
			   //"SpacerUI", GUI.fox.aswing.plaf.basic.BasicSpacerUI,
			   //"MenuBarUI", GUI.fox.aswing.plaf.basic.BasicMenuBarUI,
			   //"MenuUI", GUI.fox.aswing.plaf.basic.BasicMenuUI,
			   //"MenuItemUI", GUI.fox.aswing.plaf.basic.BasicMenuItemUI,
			   //"CheckBoxMenuItemUI", GUI.fox.aswing.plaf.basic.BasicCheckBoxMenuItemUI,
			   //"RadioButtonMenuItemUI", GUI.fox.aswing.plaf.basic.BasicRadioButtonMenuItemUI,
			   //"PopupMenuUI", GUI.fox.aswing.plaf.basic.BasicPopupMenuUI,
			   //"TreeUI", GUI.fox.aswing.plaf.basic.BasicTreeUI, 
			   //"SplitPaneUI", GUI.fox.aswing.plaf.basic.BasicSplitPaneUI
		   ];
	...
	private function initComponentDefaults(table:UIDefaults):Void{
	   // *** JButton
	    var comDefaults:Array = [
			...
			"Button.border", GUI.fox.aswing.plaf.basic.border.ButtonBorder,
	    ...
	    comDefaults = [
		    ...
		    "ToggleButton.border", GUI.fox.aswing.plaf.basic.border.ButtonBorder,
	   ...
	   // *** JTabbedPane
	    ...
	    comDefaults = [
		    ...
		    "Frame.titleBarUI", GUI.fox.aswing.plaf.basic.frame.TitleBarUI,
		    "Frame.resizer", GUI.fox.aswing.plaf.basic.frame.FrameResizer,
		    "Frame.font", table.get("windowFont"),
		    "Frame.border", GUI.fox.aswing.plaf.basic.border.FrameBorder,
		    "Frame.icon", GUI.fox.aswing.plaf.basic.frame.TitleIcon,
		    "Frame.iconifiedIcon", GUI.fox.aswing.plaf.basic.icon.FrameIconifiedIcon,
		    "Frame.normalIcon", GUI.fox.aswing.plaf.basic.icon.FrameNormalIcon,
		    "Frame.maximizeIcon", GUI.fox.aswing.plaf.basic.icon.FrameMaximizeIcon,
		    "Frame.closeIcon", GUI.fox.aswing.plaf.basic.icon.FrameCloseIcon
	    ];
	    table.putDefaults(comDefaults);	    
	   ...
	   // *** JToolTip
	    comDefaults = [
		    ...
		    "ToolTip.border", GUI.fox.aswing.plaf.basic.border.ToolTipBorder
	    ];
	    table.putDefaults(comDefaults);
	    ...
	    comDefaults = [
		    ...
		    "TextField.border", GUI.fox.aswing.plaf.basic.border.TextFieldBorder
	   	];
	    table.putDefaults(comDefaults);
	    ...
	    comDefaults = [
		    ...
		    "TextArea.border", GUI.fox.aswing.plaf.basic.border.TextAreaBorder
		];
	    table.putDefaults(comDefaults);
	    ...
	    comDefaults = [
		    ...
		    "ComboBox.border", GUI.fox.aswing.plaf.basic.border.ComboBoxBorder,
	    ...
	    comDefaults = [
			...
			"ProgressBar.border", GUI.fox.aswing.plaf.basic.border.ProgressBarBorder,
	    	"ProgressBar.icon", GUI.fox.aswing.plaf.basic.icon.ProgressBarIcon,
	    ...
	    comDefaults = [
	    	...
	    	"TableHeader.cellBorder", GUI.fox.aswing.plaf.basic.border.TableHeaderCellBorder
	    ];
	    table.putDefaults(comDefaults);
	    ...
	    comDefaults = [
	    	...
	    	"ColorChooser.border", GUI.fox.aswing.plaf.basic.border.ColorChooserBorder
	    ];
	    table.putDefaults(comDefaults);
	    ...
	    comDefaults = [
	    	...
	    	"MenuItem.arrowIcon", GUI.fox.aswing.plaf.basic.icon.MenuItemArrowIcon,
	    	"MenuItem.checkIcon", GUI.fox.aswing.plaf.basic.icon.MenuItemCheckIcon,
	    ...
	    comDefaults = [
	    	...
	    	"CheckBoxMenuItem.arrowIcon", GUI.fox.aswing.plaf.basic.icon.MenuItemArrowIcon,
	    	"CheckBoxMenuItem.checkIcon", GUI.fox.aswing.plaf.basic.icon.CheckBoxMenuItemCheckIcon,
	    ...
	    comDefaults = [
	    	...
	    	"RadioButtonMenuItem.arrowIcon", GUI.fox.aswing.plaf.basic.icon.MenuItemArrowIcon,
	    	"RadioButtonMenuItem.checkIcon", GUI.fox.aswing.plaf.basic.icon.RadioButtonMenuItemCheckIcon,
	    ...
	    comDefaults = [
	    	...
	    	"Menu.arrowIcon", GUI.fox.aswing.plaf.basic.icon.MenuArrowIcon,
	    	"Menu.checkIcon", GUI.fox.aswing.plaf.basic.icon.MenuCheckIcon,
	    ...
	    comDefaults = [
	    	...
	    	"PopupMenu.border", GUI.fox.aswing.plaf.basic.border.PopupMenuBorder
	    ];
	    table.putDefaults(comDefaults);
