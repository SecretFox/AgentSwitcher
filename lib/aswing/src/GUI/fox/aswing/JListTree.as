...
import GUI.fox.aswing.tree.list.ListTreeModel;
 ...
 * {@link GUI.fox.aswing.ListCellFactory} for details.
 ...
 * @see GUI.fox.aswing.ListCellFactory
 * @see GUI.fox.aswing.tree.TreeModel
 * @see GUI.fox.aswing.tree.list.ListTreeModel
 * @see GUI.fox.aswing.tree.list.AbstractListTreeCell
 * @see GUI.fox.aswing.tree.Identifiable
 * @see #autoDragAndDropHandler()
 * 
 * @author iiley
 */
class GUI.fox.aswing.JListTree extends JList {
    ...
    /** 
     * @see GUI.fox.aswing.ListSelectionModel#addSelectionInterval()
    ...
    /** 
     * @see GUI.fox.aswing.ListSelectionModel#removeSelectionInterval()
