...
import GUI.fox.aswing.BoundedRangeModel;
import GUI.fox.aswing.Component;
import GUI.fox.aswing.DefaultBoundedRangeModel;
import GUI.fox.aswing.Icon;
import GUI.fox.aswing.plaf.ProgressBarUI;
 ...
 * @author iiley
 */
class GUI.fox.aswing.JProgressBar extends Component {
	/**
	...
	public function getDefaultBasicUIClass():Function{
    	return GUI.fox.aswing.plaf.basic.BasicProgressBarUI;
    }
     ...
     * @see    GUI.fox.aswing.BoundedRangeModel
     */
     ...
     * @see #getOrientation()
     * @see GUI.fox.aswing.ASFont#getEmbedFonts()
     */
     ...
     * @see     #setValue()
     * @see     GUI.fox.aswing.BoundedRangeModel#getValue()
     */
     ...
     * @see     #setMinimum()
     * @see     GUI.fox.aswing.BoundedRangeModel#getMinimum()
     */	
     ...
     * @see     #setMaximum()
     * @see     GUI.fox.aswing.BoundedRangeModel#getMaximum()
     */
     ...
     * @see     GUI.fox.aswing.BoundedRangeModel#setValue()
     */	
     ...
     * @see    #getMinimum()
     * @see    #addChangeListener()
     * @see    GUI.fox.aswing.BoundedRangeModel#setMinimum()
     */	
     ...
     * @see    #getMaximum()
     * @see    #addChangeListener()
     * @see    GUI.fox.aswing.BoundedRangeModel#setMaximum()
     */	
