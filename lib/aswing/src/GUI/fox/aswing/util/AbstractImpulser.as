 ...
 * {@link GUI.fox.aswing.util.Impulse} interface. 
 *
 * @author iiley
 * @author Igor Sadovskiy
 */
class GUI.fox.aswing.util.AbstractImpulser extends EventDispatcher  {
     ...
     * 
     * @see GUI.fox.aswing.EventDispatcher#addEventListener()
