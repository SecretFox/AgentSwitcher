...
import GUI.fox.aswing.DefaultListCellFactory;
import GUI.fox.aswing.DefaultListSelectionModel;
import GUI.fox.aswing.dnd.DragManager;
import GUI.fox.aswing.dnd.ListDragImage;
import GUI.fox.aswing.dnd.ListSourceData;
import GUI.fox.aswing.dnd.SourceData;
import GUI.fox.aswing.Event;
...
import GUI.fox.aswing.ListModel;
import GUI.fox.aswing.ListSelectionModel;
import GUI.fox.aswing.MutableListModel;
import GUI.fox.aswing.plaf.ListUI;
 ...
 * @see VectorListModel
 */
class GUI.fox.aswing.JList extends ChildrenMaskedContainer implements Viewportable, LayoutManager, ListDataListener{
	...
	public function getDefaultBasicUIClass():Function{
    	return GUI.fox.aswing.plaf.basic.BasicListUI;
    }
	 ...
	 * @see #GUI.fox.aswing.MutableListModel
	 * @see #DND_NONE
	 * @see #DND_MOVE
	 * @see #DND_COPY
	 */
