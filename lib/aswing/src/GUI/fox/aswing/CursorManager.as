 ...
 * @author iiley
 */
class GUI.fox.aswing.CursorManager {
	
	private static var cursorMC:MovieClip;
	private static var cursorImage:Image;
	
	/**
	 * The default layer for cursor, default value is null, mean to use {@link GUI.fox.aswing.ASWingUtils#getRootMovieClip}.
	 * If you set a specified value to it, it will be used to replace {@link GUI.fox.aswing.ASWingUtils#getRootMovieClip}.
	 */
