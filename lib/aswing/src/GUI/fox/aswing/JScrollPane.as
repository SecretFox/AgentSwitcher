...
import GUI.fox.aswing.plaf.ScrollPaneUI;
import GUI.fox.aswing.ScrollPaneLayout;
 ...
 * 
 * @see GUI.fox.aswing.Viewportable
 * @see GUI.fox.aswing.JViewport
 * @see GUI.fox.aswing.JScrollBar
 * @author iiley
 */
class GUI.fox.aswing.JScrollPane extends Container{
	...
	public function getDefaultBasicUIClass():Function{
    	return GUI.fox.aswing.plaf.basic.BasicScrollPaneUI;
    }
     ...
     * @see #setViewport()
     * @see GUI.fox.aswing.JViewport#setView()
     */
