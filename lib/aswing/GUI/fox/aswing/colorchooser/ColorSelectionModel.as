...
import GUI.fox.aswing.IEventDispatcher;

/**
 * @author iiley
 * A model that supports selecting a <code>Color</code>.
 * 
 * @see GUI.fox.aswing.ASColor
 */
interface GUI.fox.aswing.colorchooser.ColorSelectionModel extends  IEventDispatcher{
	 ...
	 * @see GUI.fox.aswing.IEventDispatcher#addEventListener()
	 */
	 ...
	 * @see GUI.fox.aswing.AbstractColorChooserPanel#ON_COLOR_ADJUSTING
	 * @return the listener added.
	 * @see GUI.fox.aswing.IEventDispatcher#addEventListener()
     */
