...
import GUI.fox.aswing.util.StringUtils;
 ...
 * @author iiley
 */
class GUI.fox.aswing.JFrame extends JWindow {
	/**
	...
	public function getDefaultBasicUIClass():Function{
    	return GUI.fox.aswing.plaf.asw.ASWingFrameUI;
    }
     ...
     * @see GUI.fox.aswing.Component#addEventListener()
	 ...
	 * Default is false.
	 * @see GUI.fox.aswing.Resizer#setResizeDirectly()
	 */
