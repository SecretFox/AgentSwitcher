 ...
 * @author iiley
 */
class GUI.fox.aswing.plaf.ComponentUI{
     ...
     *
     * @see #uninstallUI
     * @see GUI.fox.aswing.Component#setUI
     ...
     *          and shared by multiple components
     * 
     * @see GUI.fox.aswing.Component#create
     */    
     ...
     * 
     * @see GUI.fox.aswing.Component#paint
     * @see #paintBackGround
     */
     ...
     *          and shared by multiple components
     *
     * @see GUI.fox.aswing.Component#getPreferredSize
     * @see GUI.fox.aswing.LayoutManager#preferredLayoutSize
     */
     ...
     *
     * @see GUI.fox.aswing.Component#getMinimumSize
     * @see GUI.fox.aswing.LayoutManager#minimumLayoutSize
     ...
     * @return a <code>Dimension</code> object or <code>null</code>
     *
     * @see GUI.fox.aswing.Component#getMaximumSize
     * @see GUI.fox.aswing.LayoutManager#maximumLayoutSize
     * @see #getPreferredSize
     */
