 ...
 * 
 * @author iiley
 * @see GUI.fox.aswing.DefaultListSelectionModel
 */
interface GUI.fox.aswing.ListSelectionModel extends IEventDispatcher {
	/** 
     ...
     * @see GUI.fox.aswing.JList#ON_SELECTION_CHANGED
     */  
