...
import GUI.fox.aswing.util.DepthManager;
import GUI.fox.aswing.util.HashMap;
import GUI.fox.aswing.util.MathUtils;
 ...
 * @author iiley
 */
class GUI.fox.aswing.Component extends EventDispatcher{
	 ...
	 * @see GUI.fox.aswing.AbstractButton#ON_STATE_CHANGED
	 * @see GUI.fox.aswing.ButtonModel#addChangeListener()
	 * @see GUI.fox.aswing.BoundedRangeModel#addChangeListener()
	 */	
	 ...
	 * {@link GUI.fox.aswing.awml.AwmlManager}. You should never modify this value.
	 * 
	 ...
	 * Used to obtain components through {@link GUI.fox.aswing.awml.AwmlManager}. 
     ...
     * look up the name of the <code>GUI.fox.aswing.plaf.ComponentUI</code>
     ...
     *
     * @see #setUI()
     * @see GUI.fox.aswing.UIManager#getLookAndFeel()
     * @see GUI.fox.aswing.UIManager#getUI()
     */
	 ...
	 * @see GUI.fox.aswing.RepaintManager
	 */
     ...
     * @see       #validate()
     * @see       #doLayout()
     * @see       GUI.fox.aswing.LayoutManager
     */
     ...
     * @see       #doLayout()
     * @see       GUI.fox.aswing.LayoutManager
     * @see       GUI.fox.aswing.Container#validate()
     */
