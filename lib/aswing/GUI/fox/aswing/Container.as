 ...
 * @author iiley
 */
class GUI.fox.aswing.Container extends Component{
	/**
     ...
     * @see GUI.fox.aswing.Component#revalidate()
     */
	 ...
	 * @see GUI.fox.aswing.Component#destroy()
	 */
     ...
     * {@link GUI.fox.aswing.Container#isFocusTraversalPolicyProvider}focus traversal policy provider</a>.  
     *
     ...
     * @see #setFocusTraversalPolicy()
     * @see #getFocusTraversalPolicy()
     * @see GUI.fox.aswing.ContainerOrderFocusTraversalPolicy
     * @see #setFocusTraversalPolicyProvider()
     */
	 ...
	 * @see GUI.fox.aswing.JWindow#__onChildPressed()
	 */
