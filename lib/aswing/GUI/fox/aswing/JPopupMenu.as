...
import GUI.fox.aswing.MenuSelectionManager;
import GUI.fox.aswing.plaf.PopupMenuUI;
 ...
 * @author iiley
 */
class GUI.fox.aswing.JPopupMenu extends Container implements MenuElement{
	...
	public function getDefaultBasicUIClass():Function{
    	return GUI.fox.aswing.plaf.basic.BasicPopupMenuUI;
    }
