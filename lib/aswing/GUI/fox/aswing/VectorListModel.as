...
import GUI.fox.aswing.util.List;

/**
 * The mutable list model vector implementation.
 * @author iiley
 */
class GUI.fox.aswing.VectorListModel extends AbstractListModel implements MutableListModel, List{
	...
	public function replaceAt(index:Number, obj):Object{
