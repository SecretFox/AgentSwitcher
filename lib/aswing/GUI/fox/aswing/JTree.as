...
import GUI.fox.aswing.event.TreeModelEvent;
import GUI.fox.aswing.event.TreeModelListener;
import GUI.fox.aswing.event.TreeSelectionEvent;
...
import GUI.fox.aswing.plaf.TreeUI;
import GUI.fox.aswing.tree.DefaultMutableTreeNode;
import GUI.fox.aswing.tree.DefaultTreeCell;
import GUI.fox.aswing.tree.DefaultTreeModel;
import GUI.fox.aswing.tree.DefaultTreeSelectionModel;
import GUI.fox.aswing.tree.EmptySelectionModel;
import GUI.fox.aswing.tree.GeneralTreeCellFactoryUIResource;
import GUI.fox.aswing.tree.TreeCellEditor;
import GUI.fox.aswing.tree.TreeCellFactory;
import GUI.fox.aswing.tree.TreeModel;
import GUI.fox.aswing.tree.TreePath;
import GUI.fox.aswing.tree.TreePathMap;
import GUI.fox.aswing.tree.TreeSelectionModel;
import GUI.fox.aswing.UIManager;
import GUI.fox.aswing.util.Delegate;
import GUI.fox.aswing.util.Stack;
import GUI.fox.aswing.util.Vector;
 ...
 * 
 * @see TreeModel
 * @see GUI.fox.aswing.tree.Identifiable
 * @author iiley
 */
class GUI.fox.aswing.JTree extends Container implements Viewportable, TreeModelListener, CellEditorListener{
     ...
     * @see GUI.fox.aswing.event.ExpandVetoException
     */
     ...
     * @see GUI.fox.aswing.Component#getUIClassID()
     * @see GUI.fox.aswing.UIDefaults#getUI()
     */
	...
	public function getDefaultBasicUIClass():Function{
    	return GUI.fox.aswing.plaf.basic.BasicTreeUI;
    }
