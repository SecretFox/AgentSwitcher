 ...
 * @author iiley
 */
class GUI.fox.aswing.DefaultBoundedRangeModel extends EventDispatcher implements BoundedRangeModel{
	...
	public function toString():String{
		...
		return "GUI.fox.aswing.DefaultBoundedRangeModel" + "[" + modelString + "]";
	}	
}
