...
class com.f1sr.aswing.plaf.office2003.border.TextBorder implements Border, UIResource 
{
    ...
    public function paintBorder(c:Component, g:Graphics, r:Rectangle):Void{
		...
		if(textCom.isEditable() && textCom.isEnabled())
		{
			...
			var brush:SolidBrush = new SolidBrush(UIManager.getColor("controlBorder"));	
