...
class com.f1sr.aswing.plaf.office2003.button.ScrollBarButtonUI extends BasicButtonUI{

    public function ScrollBarButtonUI(){
    	super();
    	//trace("--ScrollBarButtonUI()--");
    }
    ...
    public static function paintButtonBackGround(c:AbstractButton, g:Graphics, b:Rectangle):Void{
		...
		if(c.isOpaque())
		{
		    ...
		    g.fillRoundRect(gbrush,x+2,y+2,w-4,h-4,3);		    
