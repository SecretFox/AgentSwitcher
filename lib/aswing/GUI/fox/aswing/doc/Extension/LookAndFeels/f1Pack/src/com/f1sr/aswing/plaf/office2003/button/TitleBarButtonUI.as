...
class com.f1sr.aswing.plaf.office2003.button.TitleBarButtonUI extends BasicButtonUI{

    public function TitleBarButtonUI(){
    	super();
    	//trace("--TitleBarButtonUI()--");
    }
    ...
    public static function paintButtonBackGround(c:AbstractButton, g:Graphics, b:Rectangle):Void{
		...
		if(c.isOpaque())
		{
 			...
 			var control:ASColor = new ASColor(0x026AFE);//UIManager.getColor("inactiveCaption").brighter(0.9);//UIManager.getColor("control");
 			var light:ASColor = new ASColor(0x9EBEF5);//UIManager.getColor("controlHighlight");
