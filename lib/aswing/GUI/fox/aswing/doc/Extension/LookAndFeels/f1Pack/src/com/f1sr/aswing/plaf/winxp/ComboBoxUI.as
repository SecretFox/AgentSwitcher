...
import com.f1sr.aswing.plaf.winxp.button.ScrollBarButtonUI;
import com.f1sr.aswing.plaf.winxp.icon.ScrollBarDownIcon;


 
class com.f1sr.aswing.plaf.winxp.ComboBoxUI extends BasicComboBoxUI
{
    ...
    */
    ...
    private function getScollPane():JScrollPane{
    	if(scollPane == null){
    		...
    		scollPane.setBorder(new LineBorder(null,new ASColor(0x4D6185,100)));
