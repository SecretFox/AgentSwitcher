...
class com.f1sr.aswing.plaf.winxp.TabbedPaneUI extends BasicTabbedPaneUI {
    ...
    private function drawTabBorderAt(index:Number, b:Rectangle, paneBounds:Rectangle, g:Graphics):Void{
    	...
    	*/
    	...
    	else if(placement == JTabbedPane.BOTTOM)
    	{
		    ...
		    // middle border
	        colors = [0xFFFFFF,tabbedPane.getBackground().getRGB()];
			alphas = [100,100];
			ratios = [0, 255];
	        ...
	        g.fillRoundRect(brush,b.x+1, b.y+1, b.width-3, b.height-1,0,0,4,4); 		
    	...
    	else
    	{
	        ...
	        brush=new GradientBrush(GradientBrush.LINEAR, colors, alphas, ratios, matrix);
	        g.fillRoundRect(brush,b.x+1, b.y+1, b.width-3, b.height-1,4,4,0,0);
