...
import GUI.fox.aswing.KeyType;
import GUI.fox.aswing.KeyMap;
import GUI.fox.aswing.MenuElement;
import GUI.fox.aswing.plaf.MenuItemUI;
 ...
 * @author iiley
 */
class GUI.fox.aswing.JMenuItem extends AbstractButton implements MenuElement{
	...
	public function getDefaultBasicUIClass():Function{
    	return GUI.fox.aswing.plaf.basic.BasicMenuItemUI;
    }
